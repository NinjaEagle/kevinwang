    ...
    const projects = [
      {
        ...
        technologies:
          "Technologies I used to build this: React (Router, Hooks), Ruby on Rails, PostgreSQL, Heroku, Bootstrap, CSS.",
        img: restroomfinder,
        githubFrontEnd:
      ...
      },
      {
        ...
        technologies:
          "Technologies I used to build this: React (Router), Ruby on Rails, PostgreSQL, Heroku, Bootstrap, CSS.",
